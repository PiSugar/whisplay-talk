...
APP_HEARTBEAT_TIMEOUT_MS = _int("WHISPLAY_TALK_APP_HEARTBEAT_TIMEOUT_MS", "500")
APP_HEARTBEAT_FAILS_BEFORE_OFFLINE = _int("WHISPLAY_TALK_APP_HEARTBEAT_FAILS_BEFORE_OFFLINE", "3")
