...
from device_identity import load_or_create_device_name
...
DEVICE_NAME_FILE = os.path.expanduser(
    _get("WHISPLAY_TALK_DEVICE_NAME_FILE", "~/.config/whisplay-talk/device-name")
)
_raw_device_name = _get("WHISPLAY_TALK_DEVICE_NAME") or load_or_create_device_name(DEVICE_NAME_FILE)
...
ESPNOW_HEARTBEAT_SEC = _int("WHISPLAY_TALK_ESPNOW_HEARTBEAT_SEC", "2")
ESPNOW_PEER_TIMEOUT_SEC = _int("WHISPLAY_TALK_ESPNOW_PEER_TIMEOUT_SEC", "12")
...
PLAYOUT_PREFILL_FRAMES = _int("WHISPLAY_TALK_PLAYOUT_PREFILL_FRAMES", "6")
ESPNOW_RECEIVE_PREBUFFER_FRAMES = _int("WHISPLAY_TALK_ESPNOW_RECEIVE_PREBUFFER_FRAMES", "4")
ESPNOW_PLAYOUT_MISSING_GRACE_MS = _int("WHISPLAY_TALK_ESPNOW_PLAYOUT_MISSING_GRACE_MS", "0")
ESPNOW_PLAYOUT_REBUFFER_LOW_FRAMES = _int("WHISPLAY_TALK_ESPNOW_PLAYOUT_REBUFFER_LOW_FRAMES", "0")
ESPNOW_PLAYOUT_REBUFFER_RESUME_FRAMES = _int("WHISPLAY_TALK_ESPNOW_PLAYOUT_REBUFFER_RESUME_FRAMES", "0")
ESPNOW_PLAYOUT_PREFILL_FRAMES = _int("WHISPLAY_TALK_ESPNOW_PLAYOUT_PREFILL_FRAMES", "1")
...
AUDIO_PLAYER_BACKEND = _get("AUDIO_PLAYER_BACKEND", "aplay").strip().lower()
...
AUDIO_OPUS_BITRATE = _int("AUDIO_OPUS_BITRATE", "12000")
